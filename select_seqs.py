...
for i in range(1, INDEX):
    ...
    # After the above test check if still acceptablr if so increment the counter
    if REJECT[i] == "Acceptable":
        FOUND_ACCEPTED += 1
...
for i in range(301, REMAINING):
    ...
    REJECTFILE.write("\n")
    REJECTFILE.write("Possibly acceptable but we already had 300 so never checked it fully\n")
